...
(function() {
  jQuery(function($) {
    var j, keys, ref, results, tmpl, updateBookmarkBehaviors, updateDirectoryBehaviors, updateFont, updateShortcuts;
    tmpl = $('#option-tmpl');
    $('#width').val(options.width).bind('change keypress mousewheel', function() {
      return delay((function(_this) {
        return function() {
          return localStorage.width = parseInt(_this.value);
        };
      })(this));
    });
    $('#height').val(options.height).bind('change keypress mousewheel', function() {
      return delay((function(_this) {
        return function() {
          return localStorage.height = parseInt(_this.value);
        };
      })(this));
    });
    updateFont = function() {
    ...
    chrome.bookmarks.getTree(function(nodes) {
      ...
      return $('#root-directory').val(options.rootDirectory).change(function() {
        return delay((function(_this) {
          return function() {
            return localStorage.rootDirectory = _this.value;
          };
        })(this));
      });
    });
    $('#remember-opened-directory').attr('checked', options.rememberOpenedDirectory).change(function() {
      return delay((function(_this) {
        return function() {
          return localStorage.rememberOpenedDirectory = _this.checked;
        };
      })(this));
    });
    ...
    $('#custom-style').val(options.customStyle).bind('change keypress mousewheel', function() {
      return delay((function(_this) {
        return function() {
          return localStorage.customStyle = _this.value;
        };
      })(this));
    });
    ...
    $('#hide-scrollbar').attr('checked', options.hideScrollbar).change(function() {
      return delay((function(_this) {
        return function() {
          return localStorage.hideScrollbar = _this.checked;
        };
      })(this));
    });
    $('#close-popup-after-open-bookmark').attr('checked', options.closePopupAfterOpenBookmark).change(function() {
      return delay((function(_this) {
        return function() {
          return localStorage.closePopupAfterOpenBookmark = _this.checked;
        };
      })(this));
    });
    $('#move-directories-to-list-top').attr('checked', options.moveDirectoriesToListTop).change(function() {
      return delay((function(_this) {
        return function() {
          return localStorage.moveDirectoriesToListTop = _this.checked;
        };
      })(this));
    });
    return $('#sort-by').val(options.sortBy).change(function() {
      return delay((function(_this) {
        return function() {
          return localStorage.sortBy = _this.value;
        };
      })(this));
    });
  });
